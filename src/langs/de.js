tinymce.addI18n('de', {
  ...
  "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
    'Ihr Browser unterstützt leider keinen direkten Zugriff auf die Zwischenablage. Bitte benutzen Sie die Tastenkombinationen Strg+X/C/V.',
  ...
  'Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.':
    'Einfügen ist nun im unformatierten Textmodus. Inhalte werden ab jetzt als unformatierter Text eingefügt, bis Sie diese Einstellung wieder deaktivieren.',
  Fonts: 'Schriftarten',
  ...
  'ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.':
    'Die ID sollte mit einem Buchstaben beginnen, gefolgt von Buchstaben, Zahlen, Bindestrichen, Punkten, Doppelpunkten oder Unterstrichen.',
  ...
  'Constrain proportions': 'Proportionen einschränken',
  General: 'Allgemeine',
  Advanced: 'Erweiterte',
  Style: 'Formatvorlage',
  ...
  'The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?':
    'Diese URL scheint eine E-Mail-Adresse zu sein. Möchten Sie das dazu benötigte mailto: voranstellen?',
  'The URL you entered seems to be an external link. Do you want to add the required http:// prefix?':
    'Diese URL scheint ein externer Link zu sein. Möchten Sie das dazu benötigte http:// voranstellen?',
  'The URL you entered seems to be an external link. Do you want to add the required https:// prefix?':
    'Die eingegebene URL scheint ein externer Link zu sein. Soll das fehlende https:// davor ergänzt werden?',
  'Link list': 'Linkliste',
  ...
  'Row clipboard actions': 'Aktionen in der Zwischenablage',
  'Column clipboard actions': 'Aktionen in der Zwischenablage der Spalte',
  ...
  'Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help':
    'Rich-Text-Bereich. Drücken Sie Alt+F9 für das Menü. Drücken Sie Alt+F10 für die Symbolleiste. Drücken Sie Alt+0 für Hilfe.',
  ...
  'To open the popup, press Shift+Enter':
    'Drücken Sie Umschalt+Eingabe, um das Popup-Fenster zu öffnen.',
  'Rich Text Area': 'Rich Text Area',
  'Rich Text Area. Press ALT-0 for help.':
    'Rich-Text-Bereich. Drücken Sie Alt+0 für Hilfe.',
  ...
  'Error: Form submit field collision.':
    'Fehler: Kollision der Formularbestätigungsfelder.',
  'Error: No form element found.': 'Fehler: Kein Formularelement gefunden.',
  'Color swatch': 'Farbpalette',
  'Color Picker': 'Farbwahl',
  'Invalid hex color code: {0}': 'Ungültiger Hex-Farbcode: {0}',
  'Invalid input': 'Ungültige Eingabe',
  R: 'R',
  'Red component': 'Rote Komponente',
  G: 'G',
  'Green component': 'Grüne Komponente',
  B: 'B',
  'Blue component': 'Blaue Komponente',
  '#': '#',
  'Hex color code': 'Hex-Farbcode',
  'Range 0 to 255': 'Bereich 0 bis 255',
  Turquoise: 'Türkis',
  Green: 'Grün',
  Blue: 'Blau',
  Purple: 'Violett',
  ...
  'Open popup menu for split buttons':
    'Öffne Popup Menge um Buttons zu trennen',
  ...
  'Dropped file type is not supported':
    'Abgelegter Dateityp wird nicht unterstützt',
  'Loading...': 'Wird geladen...',
  'ImageProxy HTTP error: Rejected request':
    'ImageProxy HTTP-Fehler: Abgelehnte Anfrage',
  'ImageProxy HTTP error: Could not find Image Proxy':
    'ImageProxy HTTP-Fehler: Image Proxy konnte nicht gefunden werden',
  'ImageProxy HTTP error: Incorrect Image Proxy URL':
    'ImageProxy HTTP-Fehler: Falsche Bild-Proxy-URL',
  'ImageProxy HTTP error: Unknown ImageProxy error':
    'ImageProxy HTTP-Fehler: Unbekannter ImageProxy-Fehler',
});
